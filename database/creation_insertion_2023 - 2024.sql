...
('R1.02','DÈveloppement interfaces Web','Dev_Web','Ressource',true,1), 
('S2.05','Gestion dun projet','Gestion_proj','SAE',false,2), 
('R3.05','Programmation SystËme','prog_sys','Ressource',false,3), 
('S4.ST','Stages','stages','Stage',false,4), 
('R5.03','Politique de communication','comm','Ressource',false,5), 
('R5.06','Programmation multimÈdia','prog_media','Ressource',false,5), 
('S5.01','DÈveloppement avancÈ','dev_avancÈ','SAE',false,5), 
('S6.01','Èvolution dune application','ev_appli','SAE',false,6), 
('S6.ST','Stages','stages','Stage',false,6), 
('R1.01','Initiation DÈveloppement','Init_Dev','Ressource',false,1); 
