...
public class PanelRepartition_v2 extends JPanel
{
	private KeyListener listenerModule;

	public PanelRepartition_v2 ( KeyListener listenerModule, boolean afficherGroupes )
	{
		...
		if ( afficherGroupes )
			this.initialiserAvecGroupes ( );
		else
			this.initialiserSansGroupes ( );
	}

	private void initialiserAvecGroupes ( )
	{
	...
	public void initialiserSansGroupes ( )
	{
		GridBagConstraints gbc = new GridBagConstraints ( );
		gbc.insets = new Insets ( 5, 5, 5, 30 );
		gbc.anchor = GridBagConstraints.CENTER;
		...
		gbc.gridx = 0;
		gbc.gridy = 0;
		this.add ( new PanelRepartitionTypesHeuresSansGroupes ( new String[]{ "CM", "TP", "TD", "Tut" } ), gbc );

		// Ajout du panel des heures totales
		gbc.gridx = 1;
		gbc.gridy = 0;
		this.add ( new PanelVerticalSaisie(this.listenerModule, "Z", new boolean[]{false, false}), gbc );
	}
...
//---------------------------------------------------------------------------------------//
	 ...
	 */
	private class PanelRepartitionTypesHeuresSansGroupes extends JPanel
	{
		private Map <String, PanelVerticalSaisie> ensPnlTypeHeure;

		public PanelRepartitionTypesHeuresSansGroupes ( String[] ensTypeHeure )
		{
			this.ensPnlTypeHeure = new HashMap <String, PanelVerticalSaisie>();
		...
		{
			// ajouter le panel
			PanelVerticalSaisie pnlTypeHeure = new PanelVerticalSaisie ( PanelRepartition_v2.this.listenerModule, typeHeure, new boolean[]{true, false} );
			this.ensPnlTypeHeure.put ( typeHeure, pnlTypeHeure );
			this.add ( pnlTypeHeure );
		}
...
//---------------------------------------------------------------------------------------//
	 ...
	 */
	private class PanelRepartitionTypesHeuresAvecGroupes extends JPanel
	{
